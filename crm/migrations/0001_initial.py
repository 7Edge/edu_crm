    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(blank=True, max_length=200, verbose_name='说明')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(auto_now_add=True, verbose_name='跟进记录日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_title', models.CharField(blank=True, max_length=64, null=True, verbose_name='本节课标题')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=15, verbose_name='客户姓名')),
                ('gender', models.SmallIntegerField(choices=[(1, '男'), (2, '女')], verbose_name='性别')),
                ('education', models.SmallIntegerField(blank=True, choices=[(1, '重点大学'), (2, '普通本科'), (3, '独立院校'), (4, '民办本科'), (5, '大专'), (6, '民办专科'), (7, '高中'), (8, '其它')], null=True, verbose_name='学历')),
                ...
                ('work_status', models.SmallIntegerField(blank=True, choices=[(1, '在职'), (2, '无业')], null=True, verbose_name='职业状态')),
                ('company', models.CharField(blank=True, max_length=32, null=True, verbose_name='目前就职公司')),
                ('salary', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='当前薪资')),
                ('source_choices', models.IntegerField(choices=[(1, 'qq群'), (2, '内部转介绍'), (3, '官方网站'), (4, '百度推广'), (5, '360推广'), (6, '搜狗推广'), (7, '腾讯课堂'), (8, '广点通'), (9, '高校宣讲'), (10, '渠道代理'), (11, '51cto'), (12, '智汇推'), (13, '网盟'), (14, 'DSP'), (15, 'SEO'), (16, '其它')], default=1, verbose_name='客户来源')),
                ('status', models.SmallIntegerField(choices=[(1, '已报名'), (2, '未报名')], default=2, help_text='选择客户此时的状态', verbose_name='状态')),
                ('date', models.DateField(auto_now_add=True, verbose_name='咨询日期')),
                ('recv_date', models.DateField(null=True, verbose_name='接单日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.SmallIntegerField(choices=[(1, '成单'), (2, '跟进'), (3, '3天未跟进'), (4, '15天未成单')], verbose_name='客户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=16, verbose_name='校区名称')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('emergency_contract', models.CharField(blank=True, max_length=64, verbose_name='紧急联系人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stu_memo', models.TextField(blank=True, null=True, verbose_name='学生备注')),
